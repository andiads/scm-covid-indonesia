...
export class UserService {
  ...
  */
   ...
   */
   ...
   private USERS_API_ENDPOINT = "/users";
   private VIEW_USERS_API_ENDPOINT = "/v-users";

  constructor(private http: HttpClient) { }

  getUser(id: number): Observable<any> {
    //return this.http.get(`${this.VIEW_USERS_API_URL}/${id}`);
    return this.http.get<any[]>(`${this.VIEW_USERS_API_ENDPOINT}/${id}`);
  }

  createUser(user: Object): Observable<Object> {
    //return this.http.post(`${this.USERS_API_URL}/add`, user);
    return this.http.post<any[]>(`${this.USERS_API_ENDPOINT}/add`, user);
  }

  // tslint:disable-next-line: ban-types
  updateUser(id: number, value: any): Observable<Object> {
    //return this.http.put(`${this.USERS_API_URL}/${id}`, value);
    return this.http.put<any[]>(`${this.USERS_API_ENDPOINT}/${id}`, value);
  }

  getUserList(): Observable<any> {
    //return this.http.get(`${this.VIEW_USERS_API_URL}`);
    return this.http.get<any[]>(`${this.VIEW_USERS_API_ENDPOINT}`);
  }
